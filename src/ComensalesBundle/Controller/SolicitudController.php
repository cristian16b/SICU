...
use ComensalesBundle\Entity\TipoRechazo;
...
class SolicitudController extends Controller {
    ...
    */
    ...
    {
        return $this->render('Formulario registro/picker.html.twig');
    }
    ...
    */
    ...
    {    
        if($request->isXmlHttpRequest())
        {
            ...
            $id_facultad = $this->obtenerFacultad($facultad);
            $id_estado = $this->obtenerEstado($estado);
            $id_tipo = $this->obtenerTipo($tipo);    
            
            $ids = 'facu '. $id_facultad . ' estado ' . $id_estado . ' tipo ' . $id_tipo;
            //throw $this->createNotFoundException($ids);
            //throw $this->createNotFoundException($id_estado);
            //throw $this->createNotFoundException($id_facultad);
