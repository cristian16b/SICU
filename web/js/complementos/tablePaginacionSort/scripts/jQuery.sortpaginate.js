; (function ($, window, document, undefined) {
    ...
    Plugin.prototype.init = function () {
        ...
        _$this.closest(".sp_wrapper")
                .find(".sp_navigator")
                //.append("<span class='sp_paginate sp_previous'><a href=''>Anterior<a/></span>")
                .append(div + "<span class='sp_paginate sp_previous'><a href=''>Anterior<a/></span> <span class='sp_paginate sp_next'><a href=''>Siguiente<a/></span>" + "</div>");
